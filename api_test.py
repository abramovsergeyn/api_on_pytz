...
class Test(unittest.TestCase):
    ...
    def test_post_invalid_diffdate(self):
        headers = {'content-type': 'application/json', 'Accept-Charset': 'UTF-8'}
        data = '{"first_date": "10.10.2024 10:10:00", "first_tz": "PPP","second_date": "11:00am 2024-10-10", "second_tz": "Europe/Moscow"}'
        params = ""
    ...
    def test_post_convert(self):
        headers = {'content-type': 'application/json', 'Accept-Charset': 'UTF-8'}
        data = '{"date": "10.10.2023 10:10:00", "tz": "EST"}'
        params = ""
    ...
    def test_post_datediff(self):
        headers = {'content-type': 'application/json', 'Accept-Charset': 'UTF-8'}
        data = '{"first_date": "10.10.2024 10:10:00", "first_tz": "EST","second_date": "11:00am 2024-10-10", "second_tz": "Europe/Moscow"}'
        params = ""
        result = requests.post('http://localhost:8080/api/v1/datediff', params=params, headers=headers, data=data)
        response_body = str(result.content)
